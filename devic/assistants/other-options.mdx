...
| **API Execution**                 | Invoca al asistente mediante peticiones HTTP a la API de Devic, ideal para integraciones programáticas.  | Aplicaciones internas o frontend de mi SaaS.      |
...
![Panel de Cost Management del asistente](/other-options-assistan-cost.png)
...
- **Usa API Execution** cuando necesites control total del flujo o integración con tu frontend.
