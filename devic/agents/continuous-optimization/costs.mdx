...
![Vista general del uso de tokens por ejecución](8cd8cf88-e889-4ab0-918a-a6baa4534444.png)
...
![Detalle del desglose de tokens](802e12c1-fad0-4370-ab37-2456265e420d.png)
...
<CardGroup cols={2}>
  <Card title="Evaluaciones automáticas" icon="check-circle" href="./evaluaciones">
    Analiza el rendimiento de los agentes a través de métricas automáticas generadas por Devic.
  </Card>
  <Card title="Configuración avanzada" icon="settings" href="../other-options">
    Define límites, políticas de caché y parámetros de uso para optimizar recursos.
  </Card>
</CardGroup>
