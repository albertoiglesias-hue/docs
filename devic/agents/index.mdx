...
<CardGroup cols={2}>
  <Card title="Lanza tu primer agente" icon="boxes" href="/devic/agents/deploy-your-first-agent">
    Aprende paso a paso cómo crear, configurar y poner en marcha tu primer agente dentro de Devic.
  </Card>
  <Card title="Prompt de agente" icon="terminal" href="/devic/agents/prompt">
