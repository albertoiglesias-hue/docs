...
| Campo           | Descripción                                                                                                |
| --------------- | ---------------------------------------------------------------------------------------------------------- |
| **Nombre**      | Identificador principal del agente. Usa uno descriptivo, como _Gestor de Pedidos_ o _Analista de Tickets_. |
...
![Ejemplo de agente](/new-agent.png)
...
![Selección de modelo y proveedor](/model-selector.png)
...
![Ejemplo de Tools configuradas](/add-tools-agent.png)
...
![RAG o Knowledge en un agente](/add-context-agent-rag.png)
...
Puedes probarlo directamente desde la interfaz con el botón de test.

![Guarda y ejecutar](/save-changes-agent.png)
