...
<CardGroup cols={2}>
  <Card title="Diseña un prompt efectivo" icon="terminal" href="/devic/agents/prompt">
    Aprende las mejores prácticas para estructurar prompts que guíen con precisión el comportamiento y las decisiones de tus agentes.
  </Card>
  <Card title="Tools" icon="wrench" href="/devic/agents/tools">
    Explora las herramientas disponibles para tus agentes y cómo pueden utilizarlas para ejecutar acciones reales dentro de Devic.
  </Card>
  <Card title="RAG" icon="database" href="/devic/agents/rag">
    Descubre cómo integrar bases de conocimiento y búsqueda semántica mediante el sistema RAG nativo de Devic.
  </Card>
  <Card title="Optimización continua" icon="activity" href="/devic/agents/continuous-optimization/index">
    Aprende a mejorar el rendimiento de tus agentes mediante evaluaciones automáticas, feedback humano y ajuste iterativo.
  </Card>
</CardGroup>
